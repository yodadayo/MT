...
file: exhaust.cpp
purpose: exhaust air of all muscles.

compile with the command :
g++ -o ./EXHAUST ./exhaust.cpp ./lib/SlaveControlCommand.cpp ./lib/OperationCommand.cpp ./lib/SPIM_Ras.cpp ./libdxl/DynamixelV2.cpp -l wiringPi -lrt -lbcm2835
