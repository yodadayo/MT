...
file: supply.cpp
purpose: supply air to all muscles.

compile with the command :
g++ -o ./SUPPLY ./supply.cpp ./lib/SlaveControlCommand.cpp ./lib/OperationCommand.cpp ./lib/SPIM_Ras.cpp ./libdxl/DynamixelV2.cpp -l wiringPi -lrt -lbcm2835
